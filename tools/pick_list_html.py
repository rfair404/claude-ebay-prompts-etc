...
rendered: the sheet is meant to be handed around, printed, and photographed,
and a shipping label already carries the address. tools/pick_list.py's
terminal output (seller-only, stays on this machine) still shows the full
address for actually addressing a box.
